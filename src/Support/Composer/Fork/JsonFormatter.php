...
namespace Luclin\Support\Composer\Fork;

/*
 * This file is reference from Composer source code.
 * For the full copyright and license information, please view the LICENSE
 * file that was distributed with Composer source code.
 */
...
class JsonFormatter
{
     ...
     * @return string
     */
    public static function format(string $json,
        bool $unescapeUnicode = true, bool $unescapeSlashes = true): string
    {
        $result = '';
        $pos = 0;
        $strLen = strlen($json);
